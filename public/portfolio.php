        ...
        <section class="flex flex-col-reverse md:flex-row items-center justify-between px-5 md:px-12 my-12 gap-10">
            <div class="flex-[5] min-w-[300px]">
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <a href="https://devs-des1re.com/contact" class="inline-flex items-center gap-2 px-3 py-1 border-2 border-[#0099FF] rounded-md text-[#0099FF] transition-colors duration-300 transform hover:text-blue-500 hover:border-blue-500 transition-colors duration-100">
                        <span>Contact</span>
                    </a>
                </div>
            </div>
